export default {
  ...
  'rewards.title':
    'Добро пожаловать! Теперь у вас есть шанс выиграть у меня эту эксклюзивную футболку, которую вы больше нигде не найдете. Вам нужно только подписаться и стать моим эксклюзивным фанатом, и все. Став моим эксклюзивным поклонником, вы получите доступ к моим закадровым видео и другим сюрпризам.',
  'rewards.billing.title': 'Подпишитесь и получите шанс выиграть эксклюзивную футболку!',
  'rewards.refer': 'Вы уже подписаны, ждите лотереи на следующей неделе, а пока позовите друга!'
};
